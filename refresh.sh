...
# docker-compose.override.yml (generated by setup.sh --ssl) may remap the port
if [[ -f "docker-compose.override.yml" ]]; then
    # Extract the host port from the override's qb-engineer-ui ports mapping (e.g. "443:443")
