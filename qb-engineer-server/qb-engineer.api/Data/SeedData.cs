    ...
    public static async Task SeedEssentialDataAsync(AppDbContext db)
    {
        ...
        if (!await db.ReferenceData.AnyAsync())
        {
            db.ReferenceData.AddRange(
                ...
                new ReferenceData { IsSeedData = true, GroupCode = "expense_category", Code = "material", Label = "Material", SortOrder = 1 },
                new ReferenceData { IsSeedData = true, GroupCode = "expense_category", Code = "tooling", Label = "Tooling", SortOrder = 2 },
                new ReferenceData { IsSeedData = true, GroupCode = "expense_category", Code = "shipping", Label = "Shipping", SortOrder = 3 },
                new ReferenceData { IsSeedData = true, GroupCode = "expense_category", Code = "travel", Label = "Travel", SortOrder = 4 },
                new ReferenceData { IsSeedData = true, GroupCode = "expense_category", Code = "office", Label = "Office", SortOrder = 5 },
                new ReferenceData { IsSeedData = true, GroupCode = "expense_category", Code = "other", Label = "Other", SortOrder = 6 },
                ...
                new ReferenceData { IsSeedData = true, GroupCode = "lead_source", Code = "other", Label = "Other", SortOrder = 5 },
