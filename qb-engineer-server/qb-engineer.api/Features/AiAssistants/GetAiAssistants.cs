...
public record GetAiAssistantsQuery : IRequest<List<AiAssistantResponseModel>>;

public class GetAiAssistantsHandler(AppDbContext db) : IRequestHandler<GetAiAssistantsQuery, List<AiAssistantResponseModel>>
{
    public async Task<List<AiAssistantResponseModel>> Handle(GetAiAssistantsQuery request, CancellationToken ct)
    {
